...
1. **Silicon crystals and doping** — impurities such as phosphorous and boron are
  ...
  and p-type semiconductors.
    ...
    <Image src="/images/blogs/projects/silicon.png" width="150px" transparent alt="silicon crystal" />
...
2. **P-N junctions and diodes** — an interesting result of physically joining 
  ...
  flow, letting us implement a simple diode device.
    ...
    <Image src="/images/blogs/projects/p-n-junction.png" width="250px" transparent alt="pn junction" />
...
3. **NPN/PNP transistors** — simple transistor devices can be formed from physically
  ...
  p-n-p configuration.
    ...
    <Image src="/images/blogs/projects/npn-transistor.png" width="250px" transparent alt="npn transistor" />
...
4. **Logic gate implementation using transistors and resistors** — the primitive
  ...
  such as XOR, NAND, NOR, etc.
    ...
    <Image src="/images/blogs/projects/AND-gate-implementation.png" caption="AND gate implementation." width="250px" transparent />
...
6. **Multiplexer and demultiplexer implementation** — multiplexers take in
  ...
  and direct it towards one of many output pins, using control bits.
    ...
    <Image src="/images/blogs/projects/multiplexer.png" caption="4-way mux chip." width="250px" transparent />
...
7. **Adder chips (half-adder, full-adder and incrementer)** — from primitive
  ...
  together to form 16-bit adder chips, capable of adding two 16-bit numbers.
    ...
    <Image src="/images/blogs/projects/half-adder.png" caption="Half adder." width="250px" />
    <Image src="/images/blogs/projects/full-adder.png" caption="Full adder." width="300px" />
    <Image src="/images/blogs/projects/ripple-carry-adder.png" caption="8-bit ripple carry adder chip." width="500px" />
...
8. **Arithmetic logic unit implementation** — using a bunch of multiplexers, demultiplexers,
  ...
  and logical operations, AND, OR and NOT, on 16-bit inputs.
    ...
    <Image src="/images/blogs/projects/alu.png" caption="ALU chip. The inputs zx, nz, zy, ny, f, and no are control bits that determine what arithmetic-logic operation to perform." width="300px" />
    <Image src="/images/blogs/projects/my-alu.png" caption="My implementation of the ALU." width="500px" />
...
9. **Combinational vs. sequential chips and quartz clocks** — combinational
  ...
  device. This can be done with a central quartz clock, a [piezoelectric](https://en.wikipedia.org/wiki/Piezoelectricity) material that generates signals at a very precise frequency.
    ...
    <Image src="/images/blogs/projects/clock-signal.png" caption="Example clock signal." width="300px" />
...
10. **Latches: S-R latches, data flip-flops (D latches)** — latches are digital
  ...
  that form the fundamental units that ultimately can be composed together to form RAM chips.
    ...
    <Image src="/images/blogs/projects/sr-latch.png" caption="S-R latch implementation." width="300px" />
    <Image src="/images/blogs/projects/dff.png" caption="Data flip-flip implementation." width="300px" />
...
11. **1-bit and n-bit register construction** — registers are devices that hold
  ...
  by joining, in parallel, sixteen 1-bit registers.
    ...
    <Image src="/images/blogs/projects/1-bit-register.png" caption="1-bit register implementation." width="300px" />
    <Image src="/images/blogs/projects/16-1-bit-registers.png" caption="Sixteen 1-bit registers form a 16-bit register" width="500px" />
...
12. **Recursive ascent construction of RAM modules** — RAM is essentially just a big
  ...
  can be repeated endlessly.
    ...
    <Image src="/images/blogs/projects/RAM8.png" caption="RAM8 chip." width="500px" />
    <Image src="/images/blogs/projects/RAM64.png" caption="RAM64 chip, constructed using RAM8 chips." width="500px" />
...
13. **Counter chip implementation (for the program counter register)** — there's
  ...
  and a 16-bit register.
    ...
    <Image src="/images/blogs/projects/counter-chip.png" caption="Counter chip implementation." width="350px" />
...
14. **Computer architecture: defining the Hack instruction set and assembly language** — the
  ...
  instruction types:
    ...
    <Image src="/images/blogs/projects/A-instruction.png" caption="A-instruction structure." width="500px" />
    <Image src="/images/blogs/projects/C-instruction.png" caption="C-instruction structure." width="500px" />
...
15. **Memory-mapped I/O for interfacing with peripherals and other I/O devices** — there are a bunch
    ...
    <Image src="/images/blogs/projects/memory-mapped-io.png" caption="Memory-mapped I/O." width="500px" />
...
16. **CPU design and implementation** — it's time to put everything together.
    ...
    <Image src="/images/blogs/projects/hack-CPU.png" caption="Hack CPU implementation." width="720px" />
...
17. **Fitting everything into the Von Neumann architecture to complete the general-purpose computer** — 
    ...
    <Image src="/images/blogs/projects/hack-von-neumann-computer.png" caption="Hack computer assembled based on the Von Neumann architecture." width="720px" />
