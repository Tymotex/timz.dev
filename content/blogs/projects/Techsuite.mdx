---
title: Techsuite
description: Techsuite is a collaborative social app built with React, Flask and PostgreSQL.
published: true
date: 2022-06-05
---

import { SmallDivider } from 'src/blog-components/Divider';
import { Image } from 'src/blog-components/Image';

Techsuite is a web app that supports realtime group & direct messaging, networking and sharing ideas 🌱. I built it with React, Flask, PostgreSQL and Socket.io.
...
<Image src="/images/blogs/projects/techsuite-home-showcase.png" caption="Landing page." width="720px" />
<Image src="/images/blogs/projects/techsuite-channel-showcase.png" caption="Channel index page." width="720px" />
<Image src="/images/blogs/projects/techsuite-channel-page-showcase.png" caption="Channel page." width="720px" />
<Image src="/images/blogs/projects/techsuite-connections-showcase.png" caption="Connections page." width="720px" />
<Image src="/images/blogs/projects/techsuite-messaging-showcase.png" caption="Direct messaging." width="720px" />
<Image src="/images/blogs/projects/techsuite-profile-showcase.png" caption="Profile page." width="720px" />
<Image src="/images/blogs/projects/techsuite-news-showcase.png" caption="News page." width="720px" />
